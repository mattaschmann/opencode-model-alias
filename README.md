...
[![CI](https://github.com/mattschmann/opencode-model-alias/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/mattschmann/opencode-model-alias/actions/workflows/ci.yml)
